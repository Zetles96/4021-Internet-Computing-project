 ...
 * @property {function(string): void} setAnimation - Sets the animation of the entity.
	...
	setAnimation(animation) {
		switch (animation) {
			...
			case 'attack':
				...
				this.sprite.setSequence(sequences[`attack_${random}`]);
				break;
			case 'dead':
...
export { Entity, Samurai, SamuraiArcher, SamuraiCommander };